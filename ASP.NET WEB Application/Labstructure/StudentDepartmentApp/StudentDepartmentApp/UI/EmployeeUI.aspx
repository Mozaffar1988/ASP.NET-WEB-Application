...
<body>
    <div class="wrapper">
        ...
        <div class="box">
            ...
            <div class="box1"><asp:DropDownList runat="server" ID="DepartmentDropdownList" ></asp:DropDownList></div> 
            ...
            <div class="button">
                <asp:Button ID="saveButton" runat="server" BackColor="#FF9900" BorderColor="Red" Font-Bold="True" Font-Size="Medium" ForeColor="#6600FF" Text="Save" Width="83px" />
            </div>
            
            <div class="button">
                <asp:Button ID="showButton" runat="server" BackColor="Lime" BorderColor="#00CC00" Font-Bold="True" Font-Size="Medium" ForeColor="#CC0000"  Text="Show" Width="96px" />
            </div>
            <div class="button"><asp:Label ID="employeeMessege" runat="server" Text="" ></asp:Label></div>
        </div>
        </form>
